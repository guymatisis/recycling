...
<html lang="en">
    	...
    	<div style = "width:100vw;height:20vh;">
	       <div class = "title_bar" > 
                <div class = "title_bar_text">
                    <p id = "user_name" style="font-size: 24px; ">User Name: <?php echo $user_name;?></p>
                </div>
              </div>
            <div id="map"  ></div>
        </div>
    ...
    <body>	
        ...
        var baseMaps = {};
        L.control.layers(baseMaps,{'<img src="legend/green_5.png" /> Green': layer_green_5,'<img src="legend/Blue_4.png" /> Blue': layer_Blue_4,'<img src="legend/Carton_3.png" /> Carton': layer_Carton_3,'<img src="legend/Orange_2.png" /> Orange': layer_Orange_2,'<img src="legend/Purple_1.png" /> Purple': layer_Purple_1,"OSM Standard": layer_OSMStandard_0,}).addTo(map);
        setBounds();
		function on() {
